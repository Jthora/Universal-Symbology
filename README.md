...
- **Legal Dedication:** This repository as a package is legally dedicated to the public domain under the GNU General Public License v3.0 (GPLv3), ensuring it remains accessible for public use, modification, and distribution.
